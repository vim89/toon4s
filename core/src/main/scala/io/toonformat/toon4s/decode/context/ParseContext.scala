...
/** Parse context for error tracking.
  ...
  *
  * This case class encapsulates location information that flows through parsing operations,
  * enabling automatic error location tracking without threading location through every function.
  *
  * ==Strategy==
